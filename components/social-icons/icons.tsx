...
export function Github(props: React.ImgHTMLAttributes<HTMLImageElement>) {
  return <img src="/static/images/icons/social/github.png" alt="Github" {...props} />
}
...
export function Linkedin(props: React.ImgHTMLAttributes<HTMLImageElement>) {
  return <img src="/static/images/icons/social/linkedin.png" alt="Linkedin" {...props} />
}
...
export function Mail(props: React.ImgHTMLAttributes<HTMLImageElement>) {
  return <img src="/static/images/icons/social/mail.png" alt="Mail" {...props} />
}
